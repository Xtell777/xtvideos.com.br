document.addEventListener('DOMContentLoaded', function () {
    ...
    uploadButton.addEventListener('click', function () {
        if (fileInput.checkValidity()) {
            ...
            const file = { id: uniqueId, name: titleInput.value, description: descriptionInput.value };
    ...
    function appendFileToUI(file) {
        ...
        fileDiv.innerHTML = `<p>ID: ${file.id}</p><p>Nome: ${file.name}</p><p>Descrição: ${file.description}</p><hr>`;
